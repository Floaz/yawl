...
/**
 * A data transfer object that represents a list of org groups names and is used
...
public class OrgGroupNamesListResource implements Serializable {

	@XmlElement(name = "orggroup")
	private List<String> orgGroups;


	public OrgGroupNamesListResource() {
		orgGroups = new LinkedList<String>();
	}


	public OrgGroupNamesListResource(List<String> orgGroups) {
