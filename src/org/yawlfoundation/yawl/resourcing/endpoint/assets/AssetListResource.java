...
public class AssetListResource implements Serializable {

	@XmlElement(name = "asset")
	private List<AssetResource> assets;


	public AssetListResource() {
		assets = new LinkedList<AssetResource>();
	}


	public AssetListResource(List<AssetResource> assets) {
		this.assets = assets;
	}
	...
	public boolean add(AssetResource e) {
		return assets.add(e);
	}


	public boolean addAll(Collection<? extends AssetResource> c) {
		return assets.addAll(c);
	}
