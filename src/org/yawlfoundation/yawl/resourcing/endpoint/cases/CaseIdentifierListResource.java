...
public class CaseIdentifierListResource implements Serializable {

	@XmlElement(name = "case")
	private List<String> cases;


	public CaseIdentifierListResource() {
		cases = new LinkedList<String>();
	}


	public CaseIdentifierListResource(List<String> cases) {
		this.cases = cases;
	}
