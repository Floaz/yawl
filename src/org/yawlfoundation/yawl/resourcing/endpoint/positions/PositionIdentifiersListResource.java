...
public class PositionIdentifiersListResource implements Serializable {

	@XmlElement(name = "position")
	private List<String> positions;


	public PositionIdentifiersListResource() {
		positions = new LinkedList<String>();
	}


	public PositionIdentifiersListResource(List<String> positions) {
